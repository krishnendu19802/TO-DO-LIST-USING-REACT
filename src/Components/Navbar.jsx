...
export default function Navbar(props) {
    ...
    return (
        ...
        style={{height:'50px'}} >
            Todo-List
            <button className={`btn btn-lg  ms-auto bg-${bgcol} text-${textcol}`} onClick={props.updmode}>
                ...
                {!props.darkmode && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16">
